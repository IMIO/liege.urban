...
#
#  $ bin/test -s liege.urban -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src liege.urban.testing.LIEGE_URBAN_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/liege/urban/tests/robot/test_example.robot
#
